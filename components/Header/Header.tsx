	...
	return (
		<div className="lg:px-20 sm:px-12 px-10 m-2 rounded-lg shadow-md border-gray-100 border p-2 mb-4 pb-4">
			<div className="flex flex-col sm:flex-row justify-between mb-4">
				<div
					className={`relative lg:w-56 md:w-52 sm:w-32 w-full ${styles.logoContainer}`}>
			...
			<div
				className="space-y-1 sm:hidden w-6 flex flex-col mx-auto overflow-hidden cursor-pointer"
				onClick={() => {
			...
			<div className="flex flex-row sm:justify-between ">
				<div
					className={`sm:flex sm:text-center sm:text-sm md:text-base sm:flex-row justify-center w-full mx-auto sm:mx-0 sm:w-auto ${
