  ...
  return(
    <div className={styles.card}>
      ...
      <Link href={`/blog/${id}`} passHref>
        <Image src={isValidURL(image)?image:"https://images.unsplash.com/photo-1653031419232-c3c7c7eba0cd?crop=entropy&cs=tinysrgb&fm=jpg&ixlib=rb-1.2.1&q=80&raw_url=true&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470"} alt="news-image" layout="fill"/>
      </Link>
      </div>
